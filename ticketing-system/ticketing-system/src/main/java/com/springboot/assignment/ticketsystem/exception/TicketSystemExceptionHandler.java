...
public class TicketSystemExceptionHandler extends ResponseEntityExceptionHandler {
	...
	/**
	 * Handles EmployeeExistException
	 *
	 * @param ex the EmployeeExistException
	 * @return the ApiError object
	 */
	@ExceptionHandler(EmployeeExistException.class)
	protected ResponseEntity<Object> handleBookAlreadyExist(EmployeeExistException ex) {
	...
	protected ResponseEntity<Object> handleBookNotFound(TicketNotFoundException ex) {
